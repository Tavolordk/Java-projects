var ejecutar = (function () {
	...
	var busquedaEndososumaasegurada = function () {
		var btnEditCliente="btnEditCliente";
		$('#btnconsultarPolizaByFecha').click(function () {
			
			$.ajax({
				url: "impresionesC/BusquedaEndosoSumaAsegurada/" + $('#busquedaFechaInicio').val()+ "/" + $('#busquedaFechaFin').val(),
				method: "GET",
				beforeSend: function(){
					util.loadingStart();
				},
				success: function (dataSet) {
					var columnas = [
						...
						{ title: "Tipo Endoso", data: "tipoEndoso" },
						{
							...
							defaultContent: "<a href='impresionesC/endoso_aumento_suma/"+0+"/' target='_blank' class='"+btnEditCliente+"'>PDF</a>",
							orderable: false
						}
					];
					var boton=[
	...
	return {
		busquedaEndososumaasegurada: busquedaEndososumaasegurada,
