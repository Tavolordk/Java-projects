var ejecutar = (function () {
	...
	var busquedaEndosoCambioYCorreccion = function () {
		var btnEditCliente="btnEditCliente";
		$('#btnconsultarPolizaByFecha').click(function () {
			
			$.ajax({
				url: "impresionesC/BusquedaEndosoCambioYCorreccionNombre/" + $('#busquedaFechaInicio').val()+ "/" + $('#busquedaFechaFin').val(),
				method: "GET",
				beforeSend: function(){
					util.loadingStart();
				},
				success: function (dataSet) {
					var columnas = [
						...
						{ title: "Tipo Endoso", data: "tipoEndoso" },
						{
							...
							defaultContent: "<a href='impresionesC/"+$('#tipometodo').val()+"/"+0+"/' target='_blank' class='"+btnEditCliente+"'>PDF</a>",
							orderable: false
						}
					];
					var boton=[
	...
	return {
		busquedaEndosoCambioYCorreccion: busquedaEndosoCambioYCorreccion,
