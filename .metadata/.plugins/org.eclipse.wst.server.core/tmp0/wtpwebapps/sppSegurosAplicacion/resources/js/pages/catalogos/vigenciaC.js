	...
	var obtenerAgentes = function() {
		...
		$.ajax({
			...
			success : function(dataSet) {
				var titulo = '';
				var columna = '';
				var btnModalNotificacion = "<button type='button' class='btn btn-primary' data-toggle='modal' data-target='#exampleModal'>"+
											"Notificación"+
											"</button>";
				switch (tipoVigencia) {
				case 'P':
					titulo = 'Vigencia Póliza';
					 columna = 'terVigPol';
					break;
				case 'F':
					titulo = 'Vigencia Fianza';
					 columna = 'terVigFia';
					break;
				case 'C':
					titulo = 'Vigencia Cédula';
					 columna = 'vigenciaCedula';
					break;
				} 
				var columnas = [
					{
					...
					},
					{
						...
						render : function(data, type, row) {
							return  "<span data-toggle='collapse' class='btn btn-primary " + btnEditAgente + "'><i class='fas fa-envelope'></i></span>"
				              //return "<button type='button' class='btn btn-primary' data-toggle='modal' data-target='#exampleModal'>Notificación</button>"
						}
					}
				...
				console.log(dataSet);
				if (dataSet.mensaje === "OK") {
					tabla.iniciarTablaExport("#tablaAgentes", dataSet.dataExtra, columnas,"Reporte_Vigencias");
