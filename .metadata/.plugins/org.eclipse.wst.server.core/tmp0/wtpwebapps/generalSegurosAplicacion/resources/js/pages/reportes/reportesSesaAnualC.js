var reportesSesaAnualC= (function(){
	...
	var reporteAnualSalud = function(){
		...
		$.ajax({
			url : "ReportesSesaC/reporteAnualSalud/"+anioReporte+"/"+ramo,
			type: "GET",
			contentType : false,
			beforeSend  : function(){
				util.loadingStart();
...
/*	var reporteAnualIncendio = function(){
		...
		console.log("entro a boton SesaIncendio")
		$.ajax({
			url : "ReportesSesaC/reporteAnualIncendio",
			type: "GET",
			contentType : false,
			beforeSend  : function(){
				util.loadingStart();
