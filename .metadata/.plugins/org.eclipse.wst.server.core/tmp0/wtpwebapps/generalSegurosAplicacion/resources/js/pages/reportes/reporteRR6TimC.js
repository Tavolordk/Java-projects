var reporteRR6Trim = (function(){
	...
	var generaReporteRR6Trim = function(){
		 ...
		 if(anioReporte === null || anioReporte === '0'){
			...
			$.ajax({
				url : "ReportesSesaC/reporteTrimRR6/"+anioReporte+"/"+trimestre,
				type: "GET",
				contentType : false,
				beforeSend  : function(){
					util.loadingStart();
	...
	return{
		...
		generaReporteRR6Trim : generaReporteRR6Trim
