var analisisC = (function () {
	...
	/** *** TRAER LA TABLA DEL HISTORICO AUTOS *** */
	/** ***************************************** */
		...
		$.ajax({
				...
				success: function(dataSet){
					...
					if(dataSet.mensaje === 'OK'){
						...
						tabla.iniciarTablaTriangulo("#coberturas", dataSet.dataExtra, columnas);
...
// $('.clabe').attr('disabled', true);
	...
	var catalogoAnios = function(){
		console.log('INICIANDO AUTOS LA CARCA DE AÑOS EN ANALISISAUTOSC.JS')
		$.ajax({
			
			url         : "ReportesSesaC/anioReporteAUTOS",
			type        : "GET",
			dataType    : 'json',
			contentType : 'application/json',
			beforeSend  : function(){
			...
			success: function(dataSet){
				console.log('FUNCION AUTOS DATASET ANALISISAUTOSC.JS')
				if(dataSet.mensaje === "OK"){
...
// {name: 'Objective-C',data: [0,1, 1.5]}
	...
	var cargaSesaTxt = function(){
		console.log("INICIA EL PROCESO DE CARGA DE ARCHIVO")
