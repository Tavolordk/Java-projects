...
public class FTCAcreedorparte9 {

	public static void main(String[] args) {
		String fileNameJrxml = "C:/Users/Tavol/JaspersoftWorkspace/MyReports/FTCAcreedor(1)parte9.jrxml";
		String fileNamePdf = "C:/resultado/FTCAcreedor/parte9.pdf";
		...
		String nombreInmuebles="Casa las lomas";
		String compromisoNumero="SDGTR5698";
		
		HashMap<String,Object> params = new HashMap<String,Object>();
		params.put("expedienteNum", expedienteNum);
		params.put("nombrePropietario", nombrePropietario);
		params.put("nombreInmuebles", nombreInmuebles);
		params.put("compromisoNumero", compromisoNumero);
